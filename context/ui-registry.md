...
| ---------------------------- | --------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auth screen shell            | prototype | Gsp.html `#authScreen`                              | Feature 1.1. `#authScreen` (green gradient full-viewport centered)                                                                                                                      |
| Auth card                    | prototype | Gsp.html                                            | Feature 1.1. `.auth-card`, `.auth-header`, `.trefoil`, `.auth-tabs`, `.auth-tab` (`.active`), `.auth-body`                                                                              |
...
| Password strength meter | prototype | Gsp.html                                     | Feature 1.1. `.strength-bar`, `.strength-fill`                                                                                                    |
| Role selector           | prototype | Gsp.html                                     | Feature 1.1. `.role-selector`, `.role-btn` (`.active`)                                                                                            |
| Auth helper links       | prototype | Gsp.html                                     | Feature 1.1. `.forgot-link`, `.switch-text`, `.divider`, `.demo-btn`                                                                              |
